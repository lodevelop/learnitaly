...
if "versionName '5.4.0-native'" not in build_text: errors.append('v5.4.0 versionName missing or app/build.gradle was not fully overwritten')
if 'def defaultVersionCode = 88' not in build_text or 'versionCode resolvedVersionCode' not in build_text: errors.append('v5.4.0 dynamic/fallback versionCode configuration missing')
if "applicationId 'com.italiano2774.nativeapp'" not in build_text: errors.append('permanent update package id changed')
if 'signingConfig signingConfigs.release' not in build_text or 'CM_KEYSTORE_PATH' not in build_text: errors.append('v5.4.0 permanent release signing config missing')
