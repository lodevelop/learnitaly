...
for token in ['weeklyExamActiveDaysSinceLast','weeklyExamDue','weeklyAdjustmentActive','weeklyNewWordPercent','weeklyAdjustmentSummary','saveWeeklyExamResult','o.put("version",32)','o.put("weeklyExam",weekly)','o.optJSONObject("weeklyExam")']:
...
if errors:
    ...
    sys.exit(1)
print('Weekly exam OK: 7 active days -> 18-question six-skill test -> error evidence -> next-week focus/new-word adjustment -> backup v32')
