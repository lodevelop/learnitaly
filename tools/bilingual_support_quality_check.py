#!/usr/bin/env python3
"""v5.4.1 Chinese / English / bilingual learner-support integration gate."""
...
for token in ['5.4.1-preupgrade','LearningLanguage.applyBottomNav','LearningLanguage.watchUi','FragmentLifecycleCallbacks']:
...
need(cm,'v5.4.1','Codemagic release identity')
...
if errors:
    ...
    sys.exit(1)
print('Bilingual support OK: v5.4.1 whole-sentence English UI, 2774/2774 Chinese+English word meanings, 3 support modes, v32 persistence, major learning routes connected, fixed signing preserved.')
