...
need(store,'o.put("version",32)','backup schema v32 compatibility')
...
if errors:
    ...
    sys.exit(1)
print('Weak-word story OK: weak/due/error ranking -> audited section/example selection -> 6-10 targets -> read/listen/cloze/retell -> multi-dimension feedback -> sentence FSRS -> daily/weekly/3-day scheduling -> backup v32')
