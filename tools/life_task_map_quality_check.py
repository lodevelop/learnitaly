...
if errors:
    ...
    sys.exit(1)
print('Life task map OK: 12 unique reviewed scenarios x 3 progressive stages = 36 missions; old dialogue scores inherit; sequential unlock + daily/weekly/three-day integration + backup v32 present')
