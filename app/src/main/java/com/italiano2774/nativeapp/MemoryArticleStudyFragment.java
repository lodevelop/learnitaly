...
public class MemoryArticleStudyFragment extends Fragment {
    ...
    private String targetWordsText(){
        ...
        StringBuilder sb=new StringBuilder();for(int i=0;i<section.targetWordIds.size();i++){Word w=words.byId(section.targetWordIds.get(i));if(w==null)continue;sb.append(w.word).append("  ").append(LearningLanguage.wordMeaning(w,progress));if(i<section.targetWordIds.size()-1)sb.append(i%2==1?"\n":"    ·    ");}
