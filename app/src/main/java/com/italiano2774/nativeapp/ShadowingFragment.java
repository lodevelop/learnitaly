...
public class ShadowingFragment extends Fragment {
    ...
    private void render(){
        if(session.isEmpty())return;Line l=current();it.setText(l.it);zh.setText(LearningLanguage.sentenceSupport(words,l.it,l.zh,progress));result.setText("");result.setTextColor(ContextCompat.getColor(requireContext(),R.color.text_secondary));
