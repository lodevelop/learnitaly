...
public class ProgressStore {
    ...
    public static final int SUPPORT_ZH=LearningLanguage.MODE_ZH, SUPPORT_EN=LearningLanguage.MODE_EN, SUPPORT_BOTH=LearningLanguage.MODE_BOTH;
    ...
    public int supportLanguageMode(){return clamp(p.getInt("support_language_mode",SUPPORT_BOTH),SUPPORT_ZH,SUPPORT_BOTH);}
    public void setSupportLanguageMode(int mode){p.edit().putInt("support_language_mode",clamp(mode,SUPPORT_ZH,SUPPORT_BOTH)).apply();}
    ...
    public JSONObject exportJson(List<Word> words) throws Exception {
        JSONObject o=new JSONObject();o.put("version",32);o.put("pendingErrorRepairs",pendingErrorRepairs());o.put("startDate",startDate().toString());o.put("perDay",perDay());o.put("preferOriginalAudio",preferOriginalAudio());
